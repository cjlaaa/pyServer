    ...
    while True:
        ...
        try:
            ...
            if received_message_type == 1:
                ...
                message_type = 7890
                response_message_header = struct.pack(header_format, message_type, response_message_proto_length)
            ...
            # 处理其他请求
                ...
                raise Exception("收到错误的包", received_message_type, received_message_length, received_message)
...
while True:
    ...
    logging.debug(f"New connection from {client_address[0]}:{client_address[1]}")
